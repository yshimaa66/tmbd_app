...
PopularPerson _$PopularPersonFromJson(Map<String, dynamic> json) {
  return _PopularPerson.fromJson(json);
}

/// @nodoc
mixin _$PopularPerson {
  ...
  @JsonKey(ignore: true)
  $PopularPersonCopyWith<PopularPerson> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PopularPersonCopyWith<$Res> {
  factory $PopularPersonCopyWith(
          PopularPerson value, $Res Function(PopularPerson) then) =
      _$PopularPersonCopyWithImpl<$Res>;
  $Res call(
      {int? id,
      String? name,
...
/// @nodoc
class _$PopularPersonCopyWithImpl<$Res>
    implements $PopularPersonCopyWith<$Res> {
  _$PopularPersonCopyWithImpl(this._value, this._then);

  final PopularPerson _value;
  // ignore: unused_field
  final $Res Function(PopularPerson) _then;
...
/// @nodoc
abstract class _$$_PopularPersonCopyWith<$Res>
    implements $PopularPersonCopyWith<$Res> {
  factory _$$_PopularPersonCopyWith(
          _$_PopularPerson value, $Res Function(_$_PopularPerson) then) =
      __$$_PopularPersonCopyWithImpl<$Res>;
  @override
  $Res call(
      {int? id,
      String? name,
...
/// @nodoc
class __$$_PopularPersonCopyWithImpl<$Res>
    extends _$PopularPersonCopyWithImpl<$Res>
    implements _$$_PopularPersonCopyWith<$Res> {
  __$$_PopularPersonCopyWithImpl(
      _$_PopularPerson _value, $Res Function(_$_PopularPerson) _then)
      : super(_value, (v) => _then(v as _$_PopularPerson));

  @override
  _$_PopularPerson get _value => super._value as _$_PopularPerson;
...
/// @nodoc
@JsonSerializable()
class _$_PopularPerson extends _PopularPerson {
  _$_PopularPerson(
      {this.id,
      this.name,
  ...
  factory _$_PopularPerson.fromJson(Map<String, dynamic> json) =>
      _$$_PopularPersonFromJson(json);
  ...
  @override
  String toString() {
    return 'PopularPerson(id: $id, name: $name, alsoKnownAs: $alsoKnownAs, adult: $adult, gender: $gender, popularity: $popularity, biography: $biography, birthday: $birthday, otherImages: $otherImages, tvCasts: $tvCasts, movieCasts: $movieCasts, placeOfBirth: $placeOfBirth, knownFor: $knownFor, knownForDepartment: $knownForDepartment, profilePath: $profilePath)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  _$$_PopularPersonCopyWith<_$_PopularPerson> get copyWith =>
      __$$_PopularPersonCopyWithImpl<_$_PopularPerson>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_PopularPersonToJson(
      this,
    );
  }
}

abstract class _PopularPerson extends PopularPerson {
  factory _PopularPerson(
      {final int? id,
      final String? name,
      @JsonKey(name: 'also_known_as')
      ...
      @JsonKey(name: 'known_for_department')
          final String? knownForDepartment,
      @JsonKey(name: 'profile_path')
          final String? profilePath}) = _$_PopularPerson;
  _PopularPerson._() : super._();

  factory _PopularPerson.fromJson(Map<String, dynamic> json) =
      _$_PopularPerson.fromJson;
