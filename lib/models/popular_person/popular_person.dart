...
part 'popular_person.freezed.dart';
part 'popular_person.g.dart';

@freezed
class PopularPerson with _$PopularPerson {
  const PopularPerson._();

  factory PopularPerson({
    int? id,
    String? name,
  ...
  factory PopularPerson.fromJson(Map<String, dynamic> json) => _$PopularPersonFromJson(json);
}
